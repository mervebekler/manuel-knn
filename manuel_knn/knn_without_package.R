...
dat_training <- norm_dat[dat_samp==1, 1:8]
dat_test <- norm_dat[dat_samp==2, 1:8]

dat_target_group <- dat[dat_samp==1, 9]
dat_test_group <- dat[dat_samp==2, 9]
...
dat_pred<- my_knn( dat_training, dat_test, dat_target_group, k=3)
summary(dat_pred)
